<main class="main-content mt-1 border-radius-lg" style="background-image: url('../assets/img/vr-bg.jpg') ; background-size: cover;">
  <!-- Navbar -->
  <?php
  require __DIR__ . '/component/navbar-header.php';
  ?>
  <!-- End Navbar -->
